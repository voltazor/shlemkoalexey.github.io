...
function createCarousel(carouselBlock) {
  ...
  $("#carousel-button-prev").on("click", function () {
    ...
    console.log(carouselBlock.slick("slickGetOption", "speed"));
  });
  ...
  //вообще не отдупляю почему эта хрень не хочет работать
  /*
  $("#test-speed-input").keypress(function(){
  setTimeout(function(){
  console.log(carouselBlock.slick("slickSetOption", "speed", $("#test-speed-input").val(), true));
  console.log(carouselBlock.slick("slickGetOption", "speed"));
}, 20);
});
*/
