...
function drawChart(){
    ...
    .done(function(data){
        ...
        for (var i = 0; i < data.list.length; i++) {
            ...
            $(".week-weather-section").append("<div><img src=http://openweathermap.org/img/w/"+data.list[i].weather[0].icon+".png><div> - </div><div>03:00</div><div>"+data.list[i].weather[0].description+"</div></div>");
        };
